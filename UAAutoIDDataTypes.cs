...
namespace RfidOpcUa
{
    ...
    public class RfidScanResult : ScanResult
    {
        ...
        public static implicit operator ExpandedNodeId?(RfidScanResult? v)
        {
    ...
    public class LastAccessResult : RfidLastAccessResult
    {
        #region Constructors
        public LastAccessResult()
        {
            Initialize();
        }
        ...
        private void Initialize()
        {
            m_AccessResults = new AccessResultsCollection();
        }
        #endregion

        #region Public Properties
        public AccessResultsCollection AccessResults
        {
            get
            {
                return m_AccessResults;
            }
            set
            {
                m_AccessResults = value;
        ...
        #region Encodeable Members
        public override ExpandedNodeId TypeId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.DataTypes.LastAccessResult);
        public override ExpandedNodeId BinaryEncodingId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.Objects.LastAccessResult_Encoding_DefaultBinary);
        public override ExpandedNodeId XmlEncodingId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.Objects.LastAccessResult_Encoding_DefaultXml);

        public override void Decode(IDecoder decoder)
        {
            base.Decode(decoder);
            decoder.PushNamespace(SimaticIdent.Namespaces.SimaticIdent);
            AccessResults = (AccessResultsCollection)decoder.ReadEncodeableArray("LastAccessResult", typeof(RfidLastAccessResult));
            decoder.PopNamespace();
        }
        #endregion

        #region Private Fields
        private AccessResultsCollection m_AccessResults;
        #endregion
    }

    public class AccessResultsCollection : List<RfidLastAccessResult>
    {
        #region Constructors
        /// <summary>
        /// Initializes the collection with default values.
        /// </summary>
        public AccessResultsCollection() { }

        /// <summary>
        /// Initializes the collection with an initial capacity.
        /// </summary>
        public AccessResultsCollection(int capacity) : base(capacity) { }

        /// <summary>
        /// Initializes the collection with another collection.
        /// </summary>
        public AccessResultsCollection(IEnumerable<RfidLastAccessResult> collection) : base(collection) { }
        #endregion
        ...
        /// </summary>
        public static implicit operator AccessResultsCollection(RfidLastAccessResult[] values)
        {
            if (values != null)
            {
                return new AccessResultsCollection(values);
            }

            return new AccessResultsCollection();
        }

        /// <summary>
        /// Converts a collection to an array.
        /// </summary>
        public static explicit operator RfidLastAccessResult[] (AccessResultsCollection values)
        {
            if (values != null)
            {
    ...
    public class RfidLastAccessResult : EncodeableObject
    {
        #region Constructors
        public RfidLastAccessResult()
        {
            Initialize();
        }
        ...
        public string CodeTypeRWData
        {
            get
            {
                return m_CodeTypeRWData;
            }
            set
            {
                m_CodeTypeRWData = value;
            }
        }
        ...
        public Int32 CurrentPowerLevel
        {
            get
            {
        ...
        #region Encodeable Members
        public override ExpandedNodeId TypeId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.DataTypes.RfidLastAccessResult);
        public override ExpandedNodeId BinaryEncodingId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.Objects.RfidLastAccessResult_Encoding_DefaultBinary);
        public override ExpandedNodeId XmlEncodingId => ExpandedNodeId.Parse("nsu=" + SimaticIdent.Namespaces.SimaticIdent + ";i=" + SimaticIdent.Objects.RfidLastAccessResult_Encoding_DefaultXml);

        public override void Decode(IDecoder decoder)
        {
            decoder.PushNamespace(SimaticIdent.Namespaces.SimaticIdent);
            //EncodingMask available because optional fields present
            uint m_encodingMask = decoder.ReadUInt32("EncodingMask"); 
            BitArray bitArray = new BitArray(new[] { (int)m_encodingMask });
            bool[] encodingFlags = new bool[32];
            bitArray.CopyTo(encodingFlags, 0);
            ...
            if (encodingFlags[1])
            {
                Identifier = (ScanData)decoder.ReadEncodeable("Identifier", typeof(ScanData));
            }
            if (encodingFlags[2])
            {
                Timestamp = decoder.ReadDateTime("Timestamp");
            ...
            if (encodingFlags[4])
            {
                RWData = (ScanData)decoder.ReadEncodeable("RWData", typeof(ScanData));
            }
            if (encodingFlags[5])
            {
        ...
        private Int32 m_Antenna;
        private Int32 m_CurrentPowerLevel;
        private UInt16 m_PC;
        private string m_Polarization;
        private Int32 m_Strength;
        #endregion
    }

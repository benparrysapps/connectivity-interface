...
namespace Siemens.UAClientHelper
{
    public class UAClientHelperAPI
    {
        ...
        /// </summary>
        public MonitoredItemNotificationEventHandler ItemEventNotification = null;
        ...
        /// <param name="password">The password</param>
        /// <exception cref="Exception">Throws and forwards any exception with short error description.</exception>
        public async Task Connect(EndpointDescription endpointDescription, bool updateBeforeConnect, bool userAuth, string userName, string password)
        {
            try
            {
                //Secify application configuration
                ...
                //Hook up a validator function for a CertificateValidation event
                ApplicationConfig.CertificateValidator.CertificateValidation += Notification_CertificateValidation;
        ...
        /// <returns>ReferenceDescriptionCollection of found nodes</returns>
        /// <exception cref="Exception">Throws and forwards any exception with short error description.</exception>
        public ReferenceDescriptionCollection BrowseNodeByReferenceType(ReferenceDescription refDesc, BrowseDirection browseDir, NodeId refTypeId)
        {
            //Create a collection for the browse results
            ReferenceDescriptionCollection referenceDescriptionCollection;
            ReferenceDescriptionCollection nextreferenceDescriptionCollection;
            ...
            {
                //Browse from starting point for all object types
                mSession.Browse(null, null, nodeId, 0u, browseDir, refTypeId, true, 0, out continuationPoint, out referenceDescriptionCollection);
        ...
        public MonitoredItem AddEventMonitoredItem(Subscription subscription, string nodeIdString, string itemName, int samplingInterval, EventFilter filter)
        {
            ...
            monitoredItem.Notification += new MonitoredItemNotificationEventHandler(Notification_MonitoredEventItem);
        ...
        private void Notification_MonitoredEventItem(MonitoredItem monitoredItem, MonitoredItemNotificationEventArgs e)
        {
            ItemEventNotification(monitoredItem, e);
        }
        ...
        private static ApplicationConfiguration CreateClientConfiguration()
        {
            ...
            configuration.ApplicationName = "UA Client RFID";
            ...
            // Allow SHA1 signed partner certificates if needed
            ...
            if (clientCertificate.Result == null)
            {
                ...
                UInt16 algorithm = 256; //1 = SHA1; 256 = SHA256
            ...
            configuration.TransportQuotas.MaxArrayLength = 2147483647;
